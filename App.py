...
digital_footprint = {
  "event_datetime": fake.date_time_between_dates(datetime_start=date(2023,1,1), datetime_end=date(2023, 1, 30)),
  "username": fake.user_name,
  "ipv4": fake.ipv4,
  "ipv6": fake.ipv6,
...
with tab_main:
  ...
  data_type_pick = customer_profile_pick.update(transactional_pick).update(digital_footprint_pick)
